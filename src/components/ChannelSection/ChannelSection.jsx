...
export default function CanalSection() {
  ...
  return (
    <section className="w-full h-full bg-main-blue text-white font-Montserrat px-8 py-14 lg:py-20 flex flex-col items-center" >
      <h3 className="uppercase font-bold text-lg md:text-3xl" id='/canal' data-aos="fade-up">Meu canal do YouTube</h3>
      <iframe src="" title='Canal do YouTube do Professor Janilton Almeida' className="w-[350px] h-[220px] sm:w-[480px] sm:h-[320px] md:w-[520px] md:h-[360px] lg:w-[650px] lg:h-[380px]  mt-8 md:mt-12 border-[8px] border-white bg-slate-300" data-aos="fade-up"></iframe>
