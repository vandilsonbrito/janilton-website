...
export default function AboutSection() {
  ...
  return (
    <section className="w-full h-full bg-white my-10 px-[10%] font-Montserrat flex flex-col items-center  sm:my-16 sm:px-[20%] md:px-[15%] lg:mb-20 xl:px-[10%] text-black" id='/sobre'>
        ...
        <div className="w-full h-full flex flex-col xl:flex-row items-center gap-3 lg:gap-10">
            <div className="w-full h-full flex justify-center xl:self-start xl:mt-2" data-aos="fade-up">
              <img src={`${window.innerWidth < 800 ? JaniltonMobile : Janilton}`} alt="Imagem do Professor Janilton" className='w-[280px] h-[300px] rounded-md my-6 sm:my-10 xl:my-0 flex '/>
            </div>
